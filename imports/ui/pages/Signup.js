...
export default class Signup extends React.Component {
  ...
  this.SignUp = this.SignUp.bind(this);
    ...
    handleUsername(event) {
       this.setState({secret_code: event.target.value});
     }
  //***********************************//
  handleEmail(event) {
  ...
  render() {
    return (
      ...
      <Card shadow={0} style={{width: '512px', margin: 'auto'}}>
          <CardTitle style={{ height: '176px'}}>Sign UP</CardTitle>
...
value={this.state.password} onChange={this.handlePassword}
 ...
 />
          ...
          <CardText>
          <Textfield
       value={this.state.secret_code} onChange={this.handleCode}
       label="Secret Code.."
       floatingLabel
       style={{width: '200px'}}
       />
          ...
          <CardActions border>
            <Button raised colored onClick={(event) => this.SignUp(event)}>Sign-Up <Icon name="add" /></Button>
          </CardActions>

          <CardActions border>
          <CardText> You Have Account ? </CardText>
            <Button raised accent onClick={(event) => this.SignIn(event)}> Sign In</Button>
          </CardActions>
